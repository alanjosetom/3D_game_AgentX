    ...
    void Update()
    {
        ...
        if (gameOn)
        {
            ...
            if (currentHealth == 0)
            {
                ...
                meshAgent.speed = 0;
                Instantiate(bulletCollection, new Vector3(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z), Quaternion.identity);
